...
| **AWS STS** | Segurança e identidade | Emite credenciais temporárias | Assumir role e federação — nunca credencial fixa | [d1-review](d1/d1-review/01-resumo.md) |
...
| **SCP** | Gerenciamento e governança | Teto de permissões das contas da organização | **Limita**, nunca concede † | [d1-review](d1/d1-review/01-resumo.md) |
...
| **Network ACL** | Rede | Filtro no nível da subnet | **Stateless**, permite e nega, ordem numérica † | [d1-review](d1/d1-review/01-resumo.md) |
...
| **Site-to-Site VPN** | Rede | Túnel IPsec on-premises ↔ VPC | Rede inteira, pela internet ⚠️ | [d1-review](d1/d1-review/01-resumo.md) |
| **Client VPN** | Rede | VPN de usuário final para a VPC | **Indivíduo**, não rede ⚠️ | [d1-review](d1/d1-review/01-resumo.md) |
| **Direct Connect** | Rede | Link físico dedicado | Banda alta e latência consistente † ⚠️ | [d1-review](d1/d1-review/01-resumo.md) |
| **AWS WAF** | Segurança | Firewall de aplicação web | **Injeção SQL**; só ALB, API GW e CloudFront | [d1-review](d1/d1-review/01-resumo.md) |
| **AWS Shield** | Segurança | Proteção contra DDoS | **DDoS**; Standard vs. Advanced ⚠️ | [d1-review](d1/d1-review/01-resumo.md) |
...
| **AWS KMS** | Segurança | Gerenciamento de chaves | Gerenciado e integrado; padrão do exame | [d1-review](d1/d1-review/01-resumo.md) |
| **AWS CloudHSM** | Segurança | HSM dedicado | Tenant único, exigência regulatória † ⚠️ | [d1-review](d1/d1-review/01-resumo.md) |
| **AWS Certificate Manager** | Segurança | Provisiona e renova certificados | Criptografia **em trânsito** ⚠️ | [d1-review](d1/d1-review/01-resumo.md) |
