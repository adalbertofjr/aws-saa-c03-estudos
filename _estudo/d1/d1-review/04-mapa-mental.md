...
## 1.1 Acesso seguro
### Conta AWS
- Usuário raiz - permissões totais — NÃO alteráveis
- Proteger com MFA
...
- Menor privilégio — limita o raio do impacto
### Políticas
- De identidade — quais recursos EU acesso
- De recurso — QUEM me acessa
- Principal só existe — na de recurso
- Ler e interpretar — não escrever avançadas
### Credenciais
- NUNCA hardcode
- STS - temporárias
- Federação por role
...
- SCP LIMITA
### Role vs Usuário
- Role - temporária — pessoas e serviços
- Usuário - longo prazo — só se não der role
### Multi-conta
- Organizations - teto via SCP
- Control Tower - guardrails
- Service Catalog — provisiona sem permissão
### Federação
- AWS SSO
- Directory Service
  - Managed Microsoft AD — trust e +5000
  - AD Connector — proxy nada na nuvem
  - Simple AD - até 5000
### Monitoramento
...
- Pública vs privada
### Filtros
- Security Group — stateful - só permite
- Network ACL — stateless - permite e nega
- Tabelas de rota
- NAT Gateway
### Conectividade privada
- VPC Endpoint — sem IGW nem NAT
- PrivateLink — expõe UM serviço
- Peering — expõe a VPC inteira
- Transit Gateway
- Site-to-Site VPN
- Client VPN
- Direct Connect
### Proteção de app
- WAF - injeção SQL — só ALB, API GW, CloudFront
- Shield - DDoS — Standard vs Advanced
- GuardDuty - atividade
- Macie - PII no S3
...
### Criptografia
- Em repouso — roubo - uma parte
- Em trânsito — transferência - duas partes
- Texto simples
- Algoritmo
- Chave
- Texto cifrado
...
- ACM - trânsito
### S3
- Client-side — cifra antes de chegar
...
- Defesa em profundidade — preventivo e detecção
### Backup e DR
- Backup e Restore
- Pilot Light
- Warm Standby
